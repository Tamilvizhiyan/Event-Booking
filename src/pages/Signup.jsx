...
const Signup = () => {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      toast.success('Account created! Welcome to EventifyHub.');
      navigate('/events');
    } catch (error) {
    ...
    <div className="flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-slate-400">Join our community to start booking events.</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                type="text"
                required
                className="block w-full pl-10 pr-4 py-3 bg-slate-800/50 border border-white/10 rounded-xl text-slate-200 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all"
        ...
        <div className="relative my-8">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="px-2 bg-slate-900 text-slate-500 rounded-full">Or register with</span>
          </div>
        </div>
